...
use JRF\Storage\Internal\Engine\MySQL as MySQLEngine;
...
class BuilderTest extends TestCase
{
	...
	{
		$engine = $this->createMock(MySQLEngine::class);
		$query = Builder::create(engine: $engine, collections: ['User'], options: [], logger: new NullLogger());
	...
	{
		$driver = $this->createMock(MySQLEngine::class);
