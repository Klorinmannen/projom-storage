...
use JRF\Storage\Database\Util\Filter as UtilFilter;
...
class FilterTest extends TestCase
{
		...
		return [
			...
			'Combine filters' => [
				[
					[
						UtilFilter::combine(
							UtilFilter::build('UpdatedAt', '2024-01-01 00:00:00', Operator::LT),
							UtilFilter::build('DeletedAt', '2024-01-01 00:00:00', Operator::LTE),
							UtilFilter::build('CreatedAt', '2024-01-01 00:00:00', Operator::GTE)
						),
						LogicalOperator::AND
					]
				],
			...
			'IS_NULL' => [
				[
					[
						UtilFilter::list(['DeletedAt' => null], Operator::IS_NULL),
						LogicalOperator::AND
					]
				],
				[],
			...
			'IS_NOT_NULL' => [
				[
					[
						UtilFilter::list(['UserID' => null], Operator::IS_NOT_NULL),
						LogicalOperator::AND
					]
				],
				[],
			...
			'IN' => [
				[
					[
						UtilFilter::list(['UserID' => [1, 2, 3]], Operator::IN),
						LogicalOperator::AND
					]
				],
			...
			'Tesing "Table.Field"' => [
				[
					[
						UtilFilter::list(['UserRole.Role' => 'leader'], Operator::EQ),
						LogicalOperator::AND
					]
				],
			...
			'Complex filter' => [
				[
					...
					[
						UtilFilter::list(['UserID' => [10, 20, 30]], Operator::IN),
						LogicalOperator::OR
					],
					[
						UtilFilter::list(
			...
			'Complex filter 2' => [
				[
					...
					[
						UtilFilter::combine(
							UtilFilter::build('UserID', [10, 20, 30], Operator::IN),
							UtilFilter::build('Username', null, Operator::IS_NOT_NULL)
						),
						LogicalOperator::OR
					]
				],
			...
			'LIKE / NOT LIKE' => [
				[
					[
						UtilFilter::combine(
							UtilFilter::build('Username', 'A__a', Operator::LIKE),
							UtilFilter::build('Username', 'J%', Operator::NOT_LIKE)
						),
						LogicalOperator::AND
					]
				],
			...
			'BETWEEN / NOT BETWEEN' => [
				[
					[
						UtilFilter::combine(
							UtilFilter::build('Age', [18, 30], Operator::BETWEEN),
							UtilFilter::build('Age', [22, 26], Operator::NOT_BETWEEN)
						),
						LogicalOperator::AND
					]
				],
	...
	public function operator_not_found(): void
	{
		...
		foreach ($cases as $case) {
			...
			$filter = UtilFilter::list(['Name' => $value], $case);
